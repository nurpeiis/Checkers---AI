...
public:
    double explore(int depth, Unordered_map board, Player player);
    friend class Game;
...
private:
    ...
    void update(int depth, Unordered_map& nextBoard, long long key, Player player, double& current_point, movePosition & move);
